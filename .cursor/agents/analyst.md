...
4. I'd look only if the tape is clean, the story is early or a real product, and retail is not already the bid
5. When you're wrong — one line

Return Slack-ready rundowns only. No score names.
